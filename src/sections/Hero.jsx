function Hero() {
  return (
    <>
      <div className="w-full h-screen flex flex-col items-center justify-center bg-black bg-center">
        <div className="text-5xl font-semi-bold text-white font-ADLaM-Display select-none md:text-8xl lg:text-[10rem]">
