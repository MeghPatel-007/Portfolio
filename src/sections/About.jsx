  ...
  return (
      <section id="About" className="w-full h-screen bg-zinc-900 border-0">
        <div className="w-full relative">
          ...
          {/* i turn pixels & */}
          <div className="h-22 top-45 left-5 w-[50%] bg-orange absolute flex justify-center items-center md:w-[40%] md:h-28 md:left-20 md:top-39 lg:h-36 lg:top-49 lg:left-40 xl:w-[30%] xl:left-60">
            <div className="flex justify-center items-center">
              <div className="flex flex-col">
                <div className="font-iceberg text-sm md:text-base lg:text-lg">I turn</div>
          ...
          {/* Stories into */}
          <div className="h-20 top-90 w-[75%] bg-orange absolute text-center flex justify-center items-center md:h-25 md:top-84 lg:h-35 lg:top-115 xl:w-[70%]">
          ...
          <div className="w-[75%] h-4 md:h-6 bg-orange absolute top-125 lg:top-177 lg:h-7 right-0 md:top-130 xl:top-175"></div>
          <div className="right-10 w-[80%] md:w-[75%] h-4 md:h-6 bg-orange absolute top-135 lg:h-7 lg:top-188 md:right-10 z-1 md:top-140 xl:top-185"></div>
          <div className="w-[75%] h-4 md:h-6 bg-orange absolute top-145 lg:top-200 right-0 md:top-150 lg:h-7 xl:top-195"></div>
